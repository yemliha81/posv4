...
<div class="left2">
	...
	<div class="srcDiv row" style="margin-bottom:15px;">
		...
		<div class="col-sm-3">
			<a href="<?php echo RESERVATION;?>" class="butonX1 pull-right w100 text-center"><i class="fa fa-calendar"></i> TAKVİM</a>
		</div>
		<div class="col-sm-3">
...
$('.event-calendar').equinox({
	...
	events: [
		...
		?>
		{
			...
			title: '<div><i class="fa fa-check"></i> : <?php echo $val['onayli'];?></div><div><i class="fa fa-user"></i> : <?php echo $val['person']['total_person'];?></div> <?php if($val['beklemede'] > 0){ ?><div><i class="fa fa-clock-o"></i> :  <?php echo $val['beklemede'];?></div><?php } ?>',
