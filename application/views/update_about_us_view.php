...
<div class="left2">
	<div class="top">
		...
		<div>
			...
			<div class="row">
				<div class="col-sm-6">
					<span class="pageTitle">Hakkımızda</span>
				</div>
				<div class="col-sm-6">
	...
	<div class="mainContainer"style="padding:0 15px;">
		...
		<div class="whiteZone f13" style="padding-right:0; padding-left:0;">
			<div>
				<form action="<?php echo UPDATE_ABOUT_US_POST;?>" method="post">
					<table class="table">
						<tr>
							<td>İçerik : </td>
							<td><textarea name="page_content" class="form-control" cols="30" rows="10"><?php echo $page['page_content'];?></textarea></td>
						</tr>
						<tr>
							<td></td>
							<td><input type="submit" class="butonX1 pull-right" value="GÜNCELLE" /></td>
						</tr>
					</table>
				</form>
			</div>
