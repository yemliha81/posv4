...
<div class="left2">
	<div class="top">
		...
		<div>
			...
			<div class="row">
				<div class="col-sm-6">
					<span class="pageTitle">Ayarlar <i class="f18 fa fa-chevron-right"></i> Kullanıcı Listesi</span>
				</div>
				<div class="col-sm-6">
				...
				<div class="col-sm-12">
					...
					<div class="">
						...
						<div class="col-xs-12">
							...
							<a href="javascript:;" class="butonX1 pull-right" data-toggle="modal" data-target="#addUserModal">KULLANICI EKLE</a>
							<a href="<?php echo ARCHIVED_USERS;?>" class="butonX1 pull-right" style="margin:0 5px;">ARŞİVLENMİŞ KULLANICILAR</a>
						</div>
...
<input type="hidden" class="pass_error" value="<?php echo $_SESSION['pass_error'];?>" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		var pass_error = $(".pass_error").val();
		if(pass_error!= ''){
			swal("",pass_error,"warning");
		}
	});
	...
	$(document).on("click",".archiveUser",function(){
		var user_id = $(this).attr("userid");
		 $.ajax({
			type : 'get',
			url : '<?php echo ARCHIVE_USER;?>'+user_id,
			success : function(response){
				if(response == 'success'){
					location.reload();
				}
