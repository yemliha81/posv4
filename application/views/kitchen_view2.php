...
<style type="text/css">
	...
	.tables{width:100000px;min-height:1000px;background:#ddd;}
	...
	<div class="tbls" style="margin-bottom:2px;">
	   <div class="col-sm-4 col-xs-4 tb1x" style="padding:0;"><a href="<?php echo MAIN_BOARD;?>">Anasayfa</a></div>
	  <div class="col-sm-4 col-xs-4 tb1x " style="padding:0;"><a href="<?php echo KITCHEN;?>">Mutfaklar</a></div>
	  <div class="col-sm-4 col-xs-4 tb1x active" style="padding:0;"><a href="javascript:;">Hazır Siparişler</a></div>
