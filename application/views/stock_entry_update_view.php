	...
	<div class="left2">
		<div class="top">
			...
			<div>
				...
				<div class="row">
					<div class="col-sm-6">
						<span class="pageTitle">Stok İşlemleri <i class="fa fa-chevron-right f18"></i> Stok Girişi Güncelleme</span>
					</div>
					<div class="col-sm-6">
...
<script type="text/javascript">
	...
	$(".submForm").click(function(){
		...
		if( empty !== '1' ){
			...
			$.ajax({
				type : 'post',
				url : '<?php echo STOCK_ENTRY_UPDATE_POST;?>',
				data : df,
				success : function(response){
					if( response == 'success' ){
						...
						setTimeout(function(){
							window.location.href = '<?php echo STOCK_ENTRY_LIST;?>';
						},2000);
					}
				}
			});
	...
	$(".delR").click(function(){
		...
		swal({
		  ...
		  if (result.value) {
			...
			$.ajax({
				type : 'get',
				url : '<?php echo STOCK_DELETE.$purchase['purchase_id'];?>',
				success : function(response){
					if(response == 'success'){
