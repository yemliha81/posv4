	...
	<div class="left2">
		<div class="top">
			...
			<div>
				...
				<div class="row">
					<div class="col-sm-6">
						<span class="pageTitle">Stok İşlemleri <i class="fa fa-chevron-right f18"></i> Yeni Stok Girişi</span>
					</div>
					<div class="col-sm-6">
		...
		<div class="mainContainer"style="padding:0 15px;">
			<div class="whiteZone f13" >
				<div class="row">
					<div class="col-xs-12">
					<form id="stockForm" action="<?php echo STOCK_ENTRY_POST;?>" >
