...
define( 'DB_USER', $_SESSION['db'] );
define( 'DB_PASS', $_SESSION['dbpass'] );

$warningtime = strtotime($_SESSION['c_close_time']) - 2592000;
$lasttime = strtotime($_SESSION['c_close_time']);
$_SESSION['time_first'] = $_SESSION['c_insert_time'];
$_SESSION['time_last'] = $_SESSION['c_close_time'];
